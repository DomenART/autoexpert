...
<html>
	...
	<body class="page">
		...
		<main class="contacts innerpage">
			...
			<div class="uk-container">
				<div class="contacts__box uk-child-width-1-2@l uk-grid" uk-grid>
					<div>
						...
						<div class="uk-child-width-1-3@m uk-grid uk-margin-top" uk-grid uk-lightbox="animation: slide">
							<?php foreach($gallery as $item): ?>
							<div>
								<a class="uk-inline" href="<?php echo $item['url'] ?>" data-caption="<?php echo $item['title'] ?>">
									<img src="<?php echo $item['sizes']['medium'] ?>" alt="">
								</a>
							</div>
							<?php endforeach; ?>
						</div>
					...
					<div>
						<?php echo do_shortcode('[contact-form-7 id="86" title="Контактная форма"]') ?>
<!-- 						<form action="/wp-json/contact-form-7/v1/contact-forms/86/feedback" method="post" class="contacts-form js-form">
							...
							<div class="contacts-form__row">
								<input class="uk-input js-tel-input" type="tel" name="tel" title="Пожалуйста, заполните это поле в формате +7 (XXX) XXX-XX-XX" placeholder="Телефон:">
							</div>
							<div class="contacts-form__row">
